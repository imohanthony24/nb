...
#STATICFILES_STORAGE = 'nbl.storage.WhiteNoiseStaticFilesStorage'#whitenoise.storage.CompressedManifestStaticFilesStorage'
...
EMAIL_HOST = 'mail.nblfinancial.com'
# EMAIL_USE_TLS = True
EMAIL_PORT = 26#587
EMAIL_HOST_USER = 'info@nblfinancial.com'
EMAIL_HOST_PASSWORD = '!Pass1212@' 
